  ...
  return (
    <div>
      <header className="mb-6">
        <h1 className="text-[26px] font-semibold text-ink">Collections</h1>
        <p className="mt-1 text-[14px] text-body">
          {formatCount(collections.length)} collections in your store.
        </p>
      </header>
        ...
        <table className="w-full text-[14px]">
          <thead>
            <tr className="text-body text-[12px] uppercase border-b border-line">
              ...
              <th className="px-5 py-3 text-left font-medium">Handle</th>
