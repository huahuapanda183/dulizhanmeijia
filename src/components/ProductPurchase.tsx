 ...
 * and the nail-lineup selector row.
 */
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-stretch gap-3">
        ...
        <button
          type="button"
          className="flex-1 rounded-sm bg-ink-2 py-3.5 text-[15px] font-semibold uppercase tracking-[0.12em] text-white transition-colors hover:bg-ink"
        >
          Add to Bag
        </button>
      </div>

      {/* nail lineup selector */}
